...
class Amenity():
    ...
    #     """Create a list of Amenity objects from JSON data."""
    #     amenity_data = json.loads(data)
    #     amenity_objects = []
    #     for amenity_entry in amenity_data.get('Amenity', []):
    #         amenity = cls(id=amenity_entry.get('id'),
    #                       name=amenity_entry.get('name'),
    #                       created_at=amenity_entry.get('created_at'),
    #                       updated_at=amenity_entry.get('updated_at'))
